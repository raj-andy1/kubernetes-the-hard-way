...
You should be able to ping `k8s-controller.k8s.local` based on the `/etc/hosts` DNS entry from a previous lab.
...
k8s-node-0   Ready    <none>   10m   v1.32.3
k8s-node-1   Ready    <none>   10m   v1.32.3
```
